...
"""
function mcrun(steps, Eqsteps, outfreq, xyzfreq, conf, box, distanceMatrix, Tred, delta, σ, rng, binWidth, Nbins)
...
function main()
    ...
    xyzfreq = Int(5E4) # XYZ output frequency
    ...
    println("XYZ output frequency = ", xyzfreq)
    ...
    hist, acceptanceRatio = mcrun(steps, Eqsteps, outfreq, xyzfreq, conf, box, distanceMatrix, Tred, delta, σ, rng_xor, binWidth, Nbins)
